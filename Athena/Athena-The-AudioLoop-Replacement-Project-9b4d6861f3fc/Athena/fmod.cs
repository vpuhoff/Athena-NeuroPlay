...
namespace FMOD
{
...
#if WIN64
        public const string dll    = "athena64";
#else
        public const string dll    = "athena32";
#endif
    }
    ...
    */
    ...
    public struct TAG
    {
        ...
        public string name { get { return Marshal.PtrToStringAnsi(namePtr); } }  /* Firelight Technologies is remarkably silly! */
    }
